function injectHeader () {
  ...
  headerHTML = `<div class="container"><nav class="navbar navbar-expand-md navbar-dark bg-dark" aria-label="Fourth navbar example">
    ...
    <div class="collapse navbar-collapse" id="navbarsExample04">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <li class="nav-item">
          ...
          <ul class="dropdown-menu dropdown" aria-labelledby="dropdown04">
